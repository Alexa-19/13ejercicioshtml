...
else if (numero1<numero3 & numero3<numero2){ /* 2 if para una probabilidad de cual sera el menor mayor y intermedio*/
document.resultados1.resulmayor.value= numero2;  
document.resultados1.resulmenor.value= numero1;
document.resultados1.resulintermedio.value= numero3;
document.resultados1.resulmayor.value= numero2;
}
else if(numero3<numero1 & numero1<numero2) {/*3 if para una probabilidad de cual sera el menor mayor y intermedio*/
document.resultados1.resulmayor.value= numero2;  
document.resultados1.resulmenor.value= numero3;
document.resultados1.resulintermedio.value= numero1;
}  
else if(numero2<numero1 & numero2<numero3){/* 4 if para una probabilidad de cual sera el menor mayor y intermedio*/
document.resultados1.resulmayor.value= numero3;  
document.resultados1.resulmenor.value= numero2;
document.resultados1.resulintermedio.value= numero1;
}  
else if(numero2<numero3 & numero3<numero1){/* 5 if para una probabilidad de cual sera el menor mayor y intermedio*/
document.resultados1.resulmayor.value= numero1;  
document.resultados1.resulmenor.value= numero2;
document.resultados1.resulintermedio.value= numero3;
}   
else if(numero2<numero3 & numero3<numero1){/* 6 if para una probabilidad de cual sera el menor mayor y intermedio*/
document.resultados1.resulmayor.value= numero1;  
document.resultados1.resulmenor.value= numero2;
document.resultados1.resulintermedio.value= numero3;
}   
else if(numero1==numero2 & numero2==numero3 & numero3==numero1){  /* 7 if para una probabilidad de un igual*/
alert("Todos Son  Numeros iguales") 
} 
